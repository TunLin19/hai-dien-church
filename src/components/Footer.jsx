    ...
    <footer className="bg-cyan-800 text-white mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-holy-gold">
              Liên kết nhanh
            </h3>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="hover:text-holy-gold transition-colors"
          ...
          {/* Mass Schedule */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-holy-gold">Giờ lễ</h3>
